  ...
  this.createStructure = function(structure, output, entries, level) {
    ...
    if (groupChild.length) {
      ...
      for( val in values) {
        ...
        newStruct.children("."+groupName.toLowerCase()).first().prepend("<h"+(level)+" style=\"font-size:x-large\" class='"
                              +groupName+"' id=\""+groupNameValue+"\"><strong>"+this.fixValue(groupNameValue)+"</strong></h"+(level)+">");
